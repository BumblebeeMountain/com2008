...
public class StudentSignUp extends JPanel {
    ...
    private void createStudentButtonActionPerformed(ActionEvent e) {
        ...
        if (title.equals("") || forename.equals("") || surname.equals("") || password.equals("")
                || personalTutor.equals("") || degreeCode.equals("")) {
            rootFrame.showError("Please complete the form.");
        } else {
            try {
                Student student = StudentController.createStudent(Constants.Title.valueOf(title), forename, surname,
                        password, Constants.AccountType.STUDENT, personalTutor);
    ...
    private void initComponents() {
        ...
        // ======== panel3 ========
        {
            ...
            ((GridBagLayout) panel3.getLayout()).rowHeights = new int[] { 0, 0, 0, 33, 0, 0, 0, 0, 0, 0 };
            ...
            panel3.add(label2, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
            ...
            panel3.add(scrollPane1, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
            panel3.add(forenameBox, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
            ...
            panel3.add(label5, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
            panel3.add(surnameBox, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel3.add(label4, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel3.add(label6, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
            panel3.add(passwordBox, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
